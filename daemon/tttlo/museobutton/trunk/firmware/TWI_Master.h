...
#define TWI_TWBR				32 // 72 gives 100 kHz TWI clock for 16 MHz crystal
// 32 gives 100 kHz TWI clock for 8 MHz crystal

// Sample TWI transmission states, used in the main application.
#define SEND_DATA				0x01
#define REQUEST_DATA			0x02
#define READ_DATA_FROM_BUFFER	0x03    // Se Application note for detailed 
