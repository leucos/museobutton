 ...
 * This Revision: $Id: usbdrv.h 428 2007-12-01 13:21:09Z cs $
 */
...
#define USBDRV_VERSION  20071201
...
#define usbDeviceConnect()      ((USBOUT &= ~((1<<USBPLUS) | (1<<USBMINUS))), \
                                  (USBDDR &= ~((1<<USBPLUS) | (1<<USBMINUS))))
#define usbDeviceDisconnect()   ((USBOUT &= ~((1<<USBPLUS) | (1<<USBMINUS))), \
                                  (USBDDR |= (1<<USBPLUS) | (1<<USBMINUS)))
 ...
 * from D-, otherwise the disconnect is done by brute-force pulling D+ and D-
 * to GND. This does not conform to the spec, but it works.
 */
